## SDS R Workshop V
# Topic: Data frames (Adapted from Saltz and Stanton Introduction to Data Science)

# Show built-in datasets in R
...
# Show number of columns/variables
ncol(myCars)
